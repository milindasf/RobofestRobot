#line 1 "D:/Milinda/Robofest/Final_Code_2/Final_code_2.c"
...
#line 449 "D:/Milinda/Robofest/Final_Code_2/Final_code_2.c"
 }
#line 469 "D:/Milinda/Robofest/Final_Code_2/Final_code_2.c"
}
...
void goStraight(){
 ...
 if(k==1){
 stopAll();
#line 670 "D:/Milinda/Robofest/Final_Code_2/Final_code_2.c"
 }
 } else if(k==1){
 sensorRead();
 if(totBack==0){
...
int convert(int x_high,int x_low){
 ...
 number=number-1;
 number=~(number);
#line 970 "D:/Milinda/Robofest/Final_Code_2/Final_code_2.c"
 number=(-1)*number;
 return number;
 }else{
 number=(x_high<<8)+x_low;
...
#line 1427 "D:/Milinda/Robofest/Final_Code_2/Final_code_2.c"
}
 int stat2 =0,mem=0;
...
void main() {
 ...
 speedChange_test();
 while(1){
#line 1697 "D:/Milinda/Robofest/Final_Code_2/Final_code_2.c"
 search_arrow();
 Delay_us(100);
